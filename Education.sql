...
CREATE TABLE `address` (
  ...
  CONSTRAINT `address_ibfk_1` FOREIGN KEY (`StudentId`) REFERENCES `student` (`Id`)
...
INSERT INTO `address` VALUES (1,123,'Main St','Anytown',1);
...
INSERT INTO `course` VALUES (1,'Sociology',10,'45DPE'),(2,'Mathematics',5,'MATH101');
...
INSERT INTO `student` VALUES (1,'John','Doe'),(2,'Jane','Smith');
...
INSERT INTO `studentcourse` VALUES (1,1),(2,1),(1,2);
...
-- Dump completed on 2024-06-28 12:37:00
